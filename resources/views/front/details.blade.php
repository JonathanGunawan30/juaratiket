            ...
            <div class="flex items-center justify-between w-full h-fit rounded-[17px] border border-white/40 p-[8px_10px] bg-[#94959966] backdrop-blur-sm z-10">
                <div>
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{\Illuminate\Support\Facades\Storage::url($ticket->category->white_icon)}}" class="w-[22px] h-[22px]" alt="icon">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                        <img src="{{\Illuminate\Support\Facades\Storage::url($ticket->thumbnail)}}" class="absolute w-full h-full object-cover" alt="thumbnail">
                    </div>
                </div>
                @forelse($ticket->photo as $image)
                    <div class="swiper-slide">
                        <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                            <img src="{{\Illuminate\Support\Facades\Storage::url($image->photo)}}" class="absolute w-full h-full object-cover" alt="thumbnail">
                        </div>
                    </div>
                @empty
            ...
            <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                <div class="flex items-center gap-[14px]">
                    <div class="w-[60px] h-[60px] rounded-[20px] overflow-hidden">
                        <img src="{{\Illuminate\Support\Facades\Storage::url($ticket->seller->photo)}}" class="w-full h-full object-cover" alt="">
                    </div>
                    <div>
                        <p class="font-bold text-lg leading-[27px]">{{$ticket->seller->location}}</p>
