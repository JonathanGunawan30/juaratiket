                    ...
                    @forelse($popularTickets as $itemPopularTicket)
                        ...
                        <a href="{{route('front.details', $itemPopularTicket->slug)}}" class="card">
                            <div
                                ...
                                <img src="{{\Illuminate\Support\Facades\Storage::url($itemPopularTicket->thumbnail)}}" class="absolute w-full h-full object-cover"
                                     alt="thumbnail">
                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{route('front.category', $category->slug)}}" class="card">
                                <div
                                    ...
                                    <img src="{{\Illuminate\Support\Facades\Storage::url($category->black_icon)}}" class="w-6 h-6" alt="icon">
                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{route('front.seller', $seller->slug)}}" class="card">
                                <div
                                    ...
                                    <img src="{{\Illuminate\Support\Facades\Storage::url($seller->photo)}}" class="absolute w-full h-full object-cover"
                                         alt="thumbnail">
                                    <div
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-[14px]">
                                <div class="flex w-[90px] h-[90px] shrink-0 rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{\Illuminate\Support\Facades\Storage::url($newTicket->thumbnail)}}" class="w-full h-full object-cover"
                                         alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <p class="font-semibold text-xs leading-[18px]">{{$newTicket->seller->location}}</p>
                                    </div>
