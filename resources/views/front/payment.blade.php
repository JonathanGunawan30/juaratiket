...
<div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-[#F8F8F9]">
    ...
    <form method="POST" action="{{route('front.payment_store')}}" class="relative flex flex-col w-full px-4 gap-[18px] mt-5 pb-[30px] overflow-x-hidden" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex flex-col rounded-[30px] p-5 gap-[14px] bg-white">
            ...
            <div class="flex items-center justify-between">
                <p class="font-semibold text-sm leading-[21px]">Wajib Pajak 12%</p>
